...
const Menu = () => {
  return (
    <>
      ...
      <section className="relative flex flex-col-reverse md:flex-row items-center bg-[#d1d385] bg-gradient-to-t from-transparent to-white h-[400px]">
        <div className="relative md:w-[50%]">
          <img
        ...
        <div className="relative md:w-[50%]">
          <div className="py-[40px] px-7 lg:px-14 md:py-14 w-full">
            ...
            <h1 className="uppercase text-center sm:text-left font-RobotoMedium text-[#006400] hover:text-[#b22830] text-3xl md:text-3xl xl:text-[3rem] mb-5 mt-0 sm:mt-5 md:leading-tight cursor-pointer">
              Freeze
            </h1>
      ...
      <section className="relative flex flex-col-reverse md:flex-row items-center bg-black bg-gradient-to-r from-transparent to-white h-[400px]">
        <div className="relative md:w-[50%]">
          <div className="py-[40px] px-7 lg:px-14 md:py-14 w-full">
            ...
            <h1 className="uppercase text-center sm:text-left font-RobotoMedium text-white hover:text-[#b22830] text-3xl md:text-3xl xl:text-[3rem] mb-5 mt-0 sm:mt-5 md:leading-tight cursor-pointer">
              Trà
            </h1>
